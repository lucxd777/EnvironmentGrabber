...
const NAME = `KSLV - Disaster`
/** The version of the environment. (not game version) */
const VERSION = '0.0.3'
/** Describe the environment. */
const DESCRIPTION = `https://beatsaver.com/maps/1dc64`
...
const PROJECT_DIR =
    `C:\Users\domin\BSManager\BSInstances\1.29.1\Beat Saber_Data\CustomLevels`
/**
